...
console.error("Starting skills-over-MCP demo (Streamable HTTP) server...");
...
// Space). Set ALLOWED_HOSTS to a comma-separated list of allowed Host headers.
