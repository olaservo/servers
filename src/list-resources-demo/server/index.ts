...
import { registerDirectoryRead } from "../resources/directory.js";
...
export const createServer = () => {
  const server = new McpServer(
    ...
    },
    {
      capabilities: {
        resources: {},
        // SEP-2133 extension negotiation. directoryRead advertises support for
        // the resources/directory/read method.
      ...
      instructions:
        ...
        "links in a SKILL.md resolve against the skill's root. List a directory's " +
        "children with resources/directory/read (e.g. skill://pdf-processing).",
    }
  );

  registerSkills(server);
  registerDirectoryRead(server);
  registerDocs(server);
